...
public final class Constants {
    ...
    public static final String PRIVATE_KEY_DIR = "src/main/resources/pl/projekt/bsk/private/privateKey.txt";

    public static final String PUBLIC_KEY_DIR = "src/main/resources/pl/projekt/bsk/public/publicKey.txt";

    public static final String PASSWORD_SHA_DIR = "src/main/resources/pl/projekt/bsk/password.txt";
